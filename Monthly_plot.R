monthly_plot<-function(list_of_predictions){
...
monthly_plot_simple<-function(list_of_predictions){
  ...
  htmlwidgets::saveWidget(as_widget(pl), paste("D:/Hydro-prediction-System/ui/fwts_monthlyreport/",format(list_of_predictions$hours[100],"%Y-%m"),".html",sep=''))
